...
require (
	...
	github.com/filecoin-project/go-indexer-core v0.2.20-0.20220815181044-a448ee61c308
	...
	github.com/ipld/go-storethehash v0.1.12-0.20220815175949-fbe5b8bdcef6
