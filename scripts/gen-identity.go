...
func usage() {
	...
	fmt.Fprintln(os.Stderr, "    Generate an encrypted identity file, identity.key.encrypted, and output the associated peer ID.")
	fmt.Fprintln(os.Stderr, "    Run", name, "from a directory with a", sopsConfig, "file to generate the encrypted identity.")
	fmt.Fprintln(os.Stderr)
