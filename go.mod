...
require (
	...
	github.com/filecoin-project/go-indexer-core v0.6.9-0.20221005191911-2675a1a20440
	github.com/filecoin-project/go-legs v0.4.16-0.20221005194309-819a2c728cca
