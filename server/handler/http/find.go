...
func GetSingleCidHandler(engine *indexer.Engine) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		getCids(engine, w, []cid.Cid{c})
	}
}

func GetBatchCidHandler(engine *indexer.Engine) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func getCids(engine *indexer.Engine, w http.ResponseWriter, cids []cid.Cid) {
	log.Debugw("Find cids", "cids", cids)

	resp, err := models.PopulateResp(engine, cids)
	if err != nil {
