...
func (cl *Client) Get(ctx context.Context, c cid.Cid, e client.Endpoint) (*models.Response, error) {
...
func (cl *Client) GetBatch(ctx context.Context, cs []cid.Cid, e client.Endpoint) (*models.Response, error) {
	end, ok := e.Addr().(string)
	if !ok {
		return nil, errors.New("endpoint is of wrong type for http client. Use string")
	}
...
func (cl *Client) ImportFromManifest(ctx context.Context, dir string, provID peer.ID, e client.Endpoint) error {
	end, ok := e.Addr().(string)
	if !ok {
...
func (cl *Client) ImportFromCidList(ctx context.Context, dir string, provID peer.ID, e client.Endpoint) error {
	end, ok := e.Addr().(string)
	if !ok {
		return errors.New("endpoint is of wrong type for http client. Use string")
	}
