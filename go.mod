...
require (
	...
	github.com/filecoin-project/go-indexer-core v0.2.20-0.20220815190305-975565214692
	...
	github.com/ipld/go-storethehash v0.1.12-0.20220815185058-4ce6a2efe7e6
